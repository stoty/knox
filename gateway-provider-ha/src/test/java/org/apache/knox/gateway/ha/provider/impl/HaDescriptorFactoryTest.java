...
public class HaDescriptorFactoryTest {
   ...
   public void testCreateServiceConfig() {
      ...
      serviceConfig = HaDescriptorFactory.createServiceConfig("bar", "false", "3", "1000", null, null, null, null, null, null, null, null, null);
      assertNotNull(serviceConfig);
  ...
  public void testCreateServiceConfigActive() {
    ...
    serviceConfig = HaDescriptorFactory.createServiceConfig( "bar", "false", "3", "1000", null, null, null, "true", null, null,null, null, null);
    assertNotNull(serviceConfig);
    assertFalse(serviceConfig.isEnabled());
    assertEquals("bar", serviceConfig.getServiceName());
    assertEquals(3, serviceConfig.getMaxFailoverAttempts());
    ...
    serviceConfig = HaDescriptorFactory.createServiceConfig( "knox", "false", "4", "3000", null, null, null, null, null, null,null, null, null);
    assertNotNull(serviceConfig);
    assertFalse(serviceConfig.isEnabled());
    ...
    serviceConfig = HaDescriptorFactory.createServiceConfig( "bar", "false", "3", "1000", null, null, null, "true", "abc", null,null, null, null);
    assertNotNull(serviceConfig);
    assertFalse(serviceConfig.isEnabled());
    assertEquals("bar", serviceConfig.getServiceName());
    assertEquals(3, serviceConfig.getMaxFailoverAttempts());
    ...
    serviceConfig = HaDescriptorFactory.createServiceConfig( "bar", "false", "3", "1000", null, null, "true", null, "abc", "true",null, null, null);
    assertNotNull(serviceConfig);
    assertFalse(serviceConfig.isEnabled());
    assertEquals("bar", serviceConfig.getServiceName());
    assertEquals(3, serviceConfig.getMaxFailoverAttempts());
