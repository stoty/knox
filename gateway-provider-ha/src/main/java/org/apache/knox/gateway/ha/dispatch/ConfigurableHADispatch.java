...
public class ConfigurableHADispatch extends ConfigurableDispatch {
  ...
  public void init() {
    ...
    // I think only a seriously broken client that would mix up the sticky cookies, and even then
    // Knox would drop the a sticky cookie that does not point to a proper backend.
