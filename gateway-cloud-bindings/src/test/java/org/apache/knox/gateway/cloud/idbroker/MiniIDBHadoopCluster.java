 ...
 */
public class MiniIDBHadoopCluster extends CompositeService {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(MiniIDBHadoopCluster.class);
   ...
   * @param conf configuration to patch.
   */
  public void patchConfigWithYARNBindings(final Configuration conf) {
