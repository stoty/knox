 ...
 * From hadoop-aws
 */
public class MockJobForTesting extends Job {

  public static final String NAME = "mock";

  private static final Logger LOG =
      LoggerFactory.getLogger(MockJobForTesting.class);
  ...
  public MockJobForTesting(final JobConf conf, final String jobName)
