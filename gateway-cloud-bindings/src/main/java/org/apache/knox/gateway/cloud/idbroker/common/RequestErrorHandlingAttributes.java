...
public class RequestErrorHandlingAttributes {
  ...
  private static final Range<Integer> VALID_FAILOVER_ATTEMPT_RANGE = Range.between(2, 100);
  private static final Range<Integer> VALID_FAILOVER_SLEEP_RANGE = Range.between(1, 5);
  private static final Range<Integer> VALID_RETRY_ATTEMPT_RANGE = Range.between(2, 100);
