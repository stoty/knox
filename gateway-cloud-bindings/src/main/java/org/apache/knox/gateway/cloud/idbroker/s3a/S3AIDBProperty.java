...
public enum S3AIDBProperty implements IDBProperty {
  ...
  /**
   * {@code fs.s3a.ext.cab.credentials.expiration.offset}
   *
   * @see #PROPERTY_SUFFIX_CREDENTIALS_EXPIRATION_OFFSET
   */
  IDBROKER_CAB_CREDENTIALS_EXPIRATION_OFFSET(PROPERTY_PREFIX + "." + FS_TYPE + PROPERTY_SUFFIX_CREDENTIALS_EXPIRATION_OFFSET, IDBS3AConstants.IDBROKER_CREDENTIALS_EXPIRATION_OFFSET_SECONDS_DEFAULT);
