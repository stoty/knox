...
function buildAppJavaOpts {
    ...
    if [[ "$JAVA_VERSION" == *"$CHECK_VERSION_17"* ]]; then
        ...
        addAppJavaOpts " --add-exports java.base/sun.security.x509=ALL-UNNAMED --add-exports java.base/sun.security.pkcs=ALL-UNNAMED --add-exports java.naming/com.sun.jndi.ldap=ALL-UNNAMED --add-opens java.base/sun.security.util=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED"
    fi
