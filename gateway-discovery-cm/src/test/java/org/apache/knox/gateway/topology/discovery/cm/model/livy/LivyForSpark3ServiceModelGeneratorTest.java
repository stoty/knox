...
public class LivyForSpark3ServiceModelGeneratorTest extends AbstractServiceModelGeneratorTest {
  ...
  public void testServiceModelMetadata() {
    ...
    roleConfig.put(LivyForSpark3ServiceModelGenerator.SSL_ENABLED, "false");
    roleConfig.put(LivyForSpark3ServiceModelGenerator.LIVY_SERVER_PORT, "21357");
  ...
  protected String getServiceType() {
    return LivyForSpark3ServiceModelGenerator.SERVICE_TYPE;
  }

  @Override
  protected String getRoleType() {
    return LivyForSpark3ServiceModelGenerator.ROLE_TYPE;
  }

  @Override
  protected ServiceModelGenerator newGenerator() {
    return new LivyForSpark3ServiceModelGenerator();
  }
