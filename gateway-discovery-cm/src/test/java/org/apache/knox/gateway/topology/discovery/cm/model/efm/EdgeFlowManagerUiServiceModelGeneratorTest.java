...
import static org.apache.knox.gateway.topology.discovery.cm.model.efm.EdgeFlowManagerUiServiceModelGenerator.EFM_SERVER_PORT;
...
public class EdgeFlowManagerUiServiceModelGeneratorTest extends AbstractServiceModelGeneratorTest {

    @Test
    public void testServiceModelMetadata() {
        Map<String, String> roleConfig = new HashMap<>();
        roleConfig.put(SSL_ENABLED, "false");
        roleConfig.put(EFM_SERVER_PORT, "12345");
    ...
    protected ServiceModelGenerator newGenerator() {
        return new EdgeFlowManagerUiServiceModelGenerator();
    }
}
