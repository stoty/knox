...
public class ClientContext {
  ...
  public static class ConnectionContext extends Context {
    ...
    public ConnectionContext withTruststore(final String truststoreLocation, final String truststorePass) {
      return withTruststore(truststoreLocation, truststorePass, "");
    }
